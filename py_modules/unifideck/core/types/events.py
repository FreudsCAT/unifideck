...
class Events(StrEnum):
    ...
    SECURITY_TOKEN_ENCRYPTED = "security_token_encrypted"  # noqa: S105 — event-name enum, not a secret
    SECURITY_TOKEN_DECRYPTED = "security_token_decrypted"  # noqa: S105 — event-name enum, not a secret
    SECURITY_DECRYPT_FAILED = "security_decrypt_failed"
    SECURITY_TOKEN_FILE_MIGRATED = "security_token_file_migrated"  # noqa: S105 — event-name enum, not a secret
    ...
    SECURITY_TOKEN_AGE_EXCEEDED = "security_token_age_exceeded"  # noqa: S105 — event-name enum, not a secret
...
class ErrorCode(StrEnum):
    ...
    NOT_AUTHENTICATED = "not_authenticated"
    TOKEN_EXPIRED = "token_expired"  # noqa: S105 — event-name enum, not a secret

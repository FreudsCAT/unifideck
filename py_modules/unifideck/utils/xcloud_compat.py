...
- replay controller events when xCloud registers listeners after startup
- re-sync gamepads when focus/visibility changes
- spoof Steam Deck-style pads as Xbox/XInput-standard controllers
- spoof the page as Edge on Windows so xCloud doesn't gate native controller paths
